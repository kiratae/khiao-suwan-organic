...
const DEFAULT_SHIPPING_RATES: ShippingRate[] = [
  { carrier: 'flash_express', min_weight_kg: 0, max_weight_kg: 5, rate_thb_per_kg: 25, packaging_fee_thb: 50 },
  { carrier: 'flash_express', min_weight_kg: 5, max_weight_kg: 10, rate_thb_per_kg: 22, packaging_fee_thb: 50 },
  { carrier: 'flash_express', min_weight_kg: 10, max_weight_kg: 20, rate_thb_per_kg: 20, packaging_fee_thb: 50 },
  { carrier: 'flash_express', min_weight_kg: 20, max_weight_kg: null, rate_thb_per_kg: 18, packaging_fee_thb: 50 },
  { carrier: 'kex', min_weight_kg: 0, max_weight_kg: 5, rate_thb_per_kg: 28, packaging_fee_thb: 60 },
  { carrier: 'kex', min_weight_kg: 5, max_weight_kg: 10, rate_thb_per_kg: 24, packaging_fee_thb: 60 },
  { carrier: 'kex', min_weight_kg: 10, max_weight_kg: 20, rate_thb_per_kg: 21, packaging_fee_thb: 60 },
  { carrier: 'kex', min_weight_kg: 20, max_weight_kg: null, rate_thb_per_kg: 19, packaging_fee_thb: 60 },
]
...
async function fetchPageData() {
  ...
  if (!supabaseUrl || supabaseUrl.includes('<project-ref>')) {
    ...
    const fallbackPrices = await getMarketPrices([])
    return {
  ...
  try {
    ...
    const [
      ...
      supabase
        .from('shipping_rates')
        .select('carrier, min_weight_kg, max_weight_kg, rate_thb_per_kg, packaging_fee_thb')
        .order('carrier')
        .order('min_weight_kg'),
    ...
    const prices = await getMarketPrices(adminPrices)
